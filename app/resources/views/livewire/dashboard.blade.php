            ...
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                <div class="card h-100">
                    <div class="card-header p-3 pt-2 card-footer p-3">
                        ...
                        <div class="text-end pt-1 ">
                            <p class="text-sm mb-0 text-capitalize"><strong>Étudiants en <br> cours</strong></p>
                ...
                <div class="card">
                    <div class="card-header p-3 pt-2 card-footer p-3">
                        ...
                        <div class="text-end pt-1">
                            ...
                            <h4 class="mb-0 mt-4">{{ $nombreProfesseurs }}</h4>
                        </div>
                    </div>
                    <!-- <hr class="dark horizontal my-0">
                    <div class="card-footer p-3"></div> -->
            ...
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1 ">
                            <p class="text-sm mb-0 text-capitalize"><strong>Montant Total <br>des Professeurs <br>en Cours</strong></p>
                            <h4 class="mb-0">{{ number_format($profmontantTotalFormationsEnCours, 2, ',', ' ') }} MRU</h4>
                            <!-- <p class="card-text">{{ $montantTotalFormationsEnCours }} MRU</p> -->
                        </div>
                    </div>
                    <hr class="dark horizontal my-0">
            ...
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1 ">
                            <p class="text-sm mb-0 text-capitalize"><strong>Montant Payé<br>des Professeurs <br>en Cours</strong></p>
                            <h4 class="mb-0">{{ number_format($profmontantPaye, 2, ',', ' ') }} MRU</h4>
                        </div>
                    </div>
                    <hr class="dark horizontal my-0">
                    <div class="card-footer p-3"></div>
            ...
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1 ">
                            <p class="text-sm mb-0 text-capitalize"><strong>Reste à Payer<br>des Professeurs <br>en Cours</strong></p>
                            <h4 class="mb-0">{{ number_format($profresteAPayer, 2, ',', ' ') }} MRU</h4>
                        </div>
                    </div>
                    <hr class="dark horizontal my-0">
                    <div class="card-footer p-3"></div>
            ...
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                            <p class="text-sm mb-0 text-capitalize"><strong>Montant Total <br>des Professeurs <br>Terminées</strong></p>
                            <h4 class="mb-0">{{ number_format($profmontantTotalFormationsTerminees, 2, ',', ' ') }} MRU</h4>
                        </div>
                    </div>
                    <hr class="dark horizontal my-0">
                    <div class="card-footer p-3"></div>
            ...
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1 ">
                            <p class="text-sm mb-0 text-capitalize"><strong>Montant Payé<br>des Professeurs <br>Terminées</strong></p>
                            <h4 class="mb-0">{{ number_format($profmontantPayeTermines, 2, ',', ' ') }} MRU</h4>
                        </div>
                    </div>
                    <hr class="dark horizontal my-0">
                    <div class="card-footer p-3"></div>
            ...
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1 ">
                            <p class="text-sm mb-0 text-capitalize"><strong>Reste à Payer<br>des Professeurs <br>Terminées</strong></p>
                            <h4 class="mb-0">{{ number_format($profresteAPayerTermines, 2, ',', ' ') }} MRU</h4>
                        </div>
                    </div>
                    <hr class="dark horizontal my-0">
                    <div class="card-footer p-3"></div>
